# Kinetic Foundry — Vertical Slice 0.1
...
- Enemy-held excavator that can be hijacked.
- Player-driven excavator locomotion.
- Direct boom/stick/tool manipulation.
- Excavator impacts against enemies and supports.
